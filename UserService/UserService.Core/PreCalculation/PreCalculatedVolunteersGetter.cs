...
{
    public class PrecalculatedVolunteersGetter : IPrecalculatedVolunteersGetter
    {
        private readonly IRepository _repository;
        private readonly IAddressService _addressService;
        private readonly IOptionsSnapshot<ApplicationConfig> _applicationConfig;

        public PrecalculatedVolunteersGetter(IRepository repository, IAddressService addressService, IOptionsSnapshot<ApplicationConfig> applicationConfig)
        {
        ...
        public async Task<IEnumerable<PrecalculatedVolunteerDto>> GetAllPrecalculatedVolunteersAsync(CancellationToken cancellationToken)
        {
            ...
            {
                return new List<PrecalculatedVolunteerDto>();
            }
            ...
            List<PrecalculatedVolunteerDto> cachedVolunteerDtos =
                (from volunteerForCacheDto in volunteerForCacheDtos
                 ...
                 select new PrecalculatedVolunteerDto
                 {
